...
  return (
    <Box sx={{backgroundImage: 'url(https://img.freepik.com/premium-photo/futuristic-electonical-technology-ai-concept-art_784842-1020.jpg)',
              backgroundSize: 'cover', 
              backgroundPosition: 'center',
              backgroundRepeat: 'no-repeat', 
              minHeight: '100vh',
              p: { xs: 1, md: 20 }, display: 'flex',
              alignItems: 'center',
            }}>
...
                           sx={{color: '#F5F7FA', mt: { xs: 14, md: 10 },
                                mb: { xs: 3.5, md: 4 }, fontFamily: 'Impact, sans-serif',
                                fontSize: { xs: '33px', md: '60px' }, textAlign: { xs: 'center', md: 'left' },
...
                       }} >
                 By clicking the the button, you are agreeing to
               </Box>{' '}
                 <Box component="span"
